/* apps.c — the pedal, and whether to believe it.
 *
 ...
 * them, on different slopes, and the job is not to read the pedal — it is
 * to decide whether the two stories agree enough to act on.
 *
 * Rules T.4 and EV.4 are cited below where they bite.
 *
